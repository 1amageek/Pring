 ...
 */
public final class CountableNestedCollection<T: Document>: AnySubCollection, Countable, ExpressibleByArrayLiteral {
...
public extension CountableNestedCollection {
...
extension CountableNestedCollection: Collection {
