 ...
 */
public final class CountableReferenceCollection<T: Document>: AnySubCollection, Countable, ExpressibleByArrayLiteral {
...
extension CountableReferenceCollection: Collection {
